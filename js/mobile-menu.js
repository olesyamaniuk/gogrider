document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".i-f-navigation-list");
  const headerRef = document.querySelector(".i-f-header");
  const navigationRef = document.querySelector(".i-f-navigation");
  ...
  document.querySelectorAll(".i-f-navigation-link").forEach((n) =>
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".i-f-toggle-button img");
